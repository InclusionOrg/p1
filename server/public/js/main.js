...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // const openReservations = Object.keys(reservations).filter(time => {
  //   return reservations[time];
  // });
  // console.log('openReservations:', openReservations);

  // setReservations(openReservations);
});
